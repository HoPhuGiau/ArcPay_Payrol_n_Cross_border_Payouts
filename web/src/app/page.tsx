  ...
  return (
    <div className="min-h-screen pb-12">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <div className="mb-12 text-center sm:text-left">
          ...
          <p className="text-lg text-zinc-500 dark:text-zinc-400 max-w-2xl">
            Manage your company payroll efficiently on the <span className="text-zinc-900 dark:text-white font-semibold">Arc Network</span>.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 flex flex-col gap-8">
            <CompanyRegistration />
            {/* Placeholder for future widgets (Stats, etc) */}
            <div className="glass-card p-6 rounded-xl hidden lg:block">
              <h3 className="text-sm font-semibold text-zinc-500 mb-4 uppercase tracking-wider">Market Rates</h3>
      ...
      <footer className="mt-20 py-8 text-center text-sm text-zinc-400 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50">
        <p>Powered by <span className="font-semibold text-zinc-600 dark:text-zinc-300">Arc Network</span> &copy; 2025</p>
      </footer>
    </div>
  );
}
